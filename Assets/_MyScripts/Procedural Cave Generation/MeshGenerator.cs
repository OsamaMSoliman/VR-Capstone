...
public class MeshGenerator
{
	...
	public MeshGenerator( GameObject gameObject , MeshFilter walls , MeshFilter cave , float wallHeight , bool is2D )
	{
		this.walls = walls;
		this.cave = cave;
	...
	{
		MeshCollider currentCollider = gameObject.GetComponent<MeshCollider>();
		Object.Destroy(currentCollider);
